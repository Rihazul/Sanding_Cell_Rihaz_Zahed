...
def mod3tool2edgesmall(force,cps):
    ...
    point2air=[p1[0]/2,p1[1]-20,p1[2]+45-3,0,21.998,-90]
    ...
    pointtop2air=[(p4[0]/2),p2[1]+2+3+10,p1[2]+45-3,0,21.998,90]
    print("pointtop2air =",pointtop2air)
    pointtop1Combo=[(p1[0]/2),p2[1]+2+3+10,p1[2]+45-3,0,21.998,90]
