...
def model3tool2big(force,cps):
    def model3tool2bigbig(force,cps):
        ...
        point2=[p1[0]/5,p1[1]-4,p1[2]+45,0,0,-90]
        print("point2=",point2)
        ...
        #Left Points
        pointleft1=[(p1[0]/5)+4,frameOutside/2,p1[2]+45,0,0,0]
        print("pointleft1=",pointleft1)
        pointleft1pre=[(p1[0]/5)+2+5,frameOutside/2,p1[2]+45,0,0,0]
        print("pointleft1pre=",pointleft1pre)
        pointleft12=[(p1[0]/5)+4,(frameOutside/2)+1+1,p1[2]+45,0,0,0]
        print("pointleft12=",pointleft12)
        pointleft2=[(p1[0]/5)+4,p2[1]-(frameOutside/2),p1[2]+45,0,0,0]
