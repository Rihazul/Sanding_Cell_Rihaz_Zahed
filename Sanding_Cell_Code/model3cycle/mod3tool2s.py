...
def mod3tool2small(force,cps,section=None,return_home=True,pass_index=None):
    ...
    point2=[p1[0]/2,p1[1]-4,p1[2]+45,0,0,-90]
    print("point2=",point2)
    ...
    #Left Points
    pointleft1=[(p1[0]/2)+4,frameOutside/2,p1[2]+45,0,0,0]
    print("pointleft1=",pointleft1)
    pointleft1pre=[(p1[0]/2)+2+5,frameOutside/2,p1[2]+45,0,0,0]
    print("pointleft1pre=",pointleft1pre)
    pointleft12=[(p1[0]/2)+4,(frameOutside/2)+1+1,p1[2]+45,0,0,0]
    print("pointleft12=",pointleft12)
    pointleft2=[(p1[0]/2)+4,p2[1]-(frameOutside/2),p1[2]+45,0,0,0]
    print("pointleft2=",pointleft2)
    pointleft2pre=[(p1[0]/2)+2+5+10,p2[1]-(frameOutside/2),p1[2]+45,0,0,0]
