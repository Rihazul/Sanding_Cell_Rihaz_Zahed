...
from model3cycle.mod3tool2edges import mod3tool2edgesmall
...
def mod3tool2edgesbig(force,cps,section=None,return_home=True,pass_index=None):
    def mod3tool2edgesbig(force,cps,section=None,return_home=True,pass_index=None):
        ...
        point2=[p1[0]/4,p1[1]-8,p1[2]+45-3,0,22,-90]
        print("point2=",point2)
        point2before=[(p1[0]/4)-1,p1[1]+1,p1[2]+45-3,0,22,-90]
        print("point2before=",point2before)
        point2pre=[p1[0]/4,p1[1]-5-5-10-5,p1[2]+45-3,0,22,-90]
        print("point2pre=",point2pre)
        point2air=[p1[0]/4,p1[1]-5,p1[2]+45-3,0,22,-90]
        ...
        #Left Points
        pointleft1=[(p1[0]/4)+8,frameOutside/2,p1[2]+45-3,0,22,0]
        print("pointleft1=",pointleft1)
        pointleft1pre=[(p1[0]/4)+2+5,frameOutside/2,p1[2]+45-3,0,22,0]
        print("pointleft1pre=",pointleft1pre)
        pointleft12=[(p1[0]/4)+8,(frameOutside/2)+2,p1[2]+45-3,0,22,0]
        print("pointleft12=",pointleft12)
        pointleft2=[(p1[0]/4)+8,p2[1]-(frameOutside/2),p1[2]+45-3,0,22,0]
        print("pointleft2=",pointleft2)
        pointleft2pre=[(p1[0]/4)+2+5+10,p2[1]-(frameOutside/2),p1[2]+45-3,0,22,0]
        ...
        #Top Cycle Points
        pointtop1=[(p1[0]/4),p2[1]+8,p1[2]+45-3,0,22,90]
        print("pointtop1=",pointtop1)
        pointtop1pre=[(p1[0]/4),p2[1]+2+8,p1[2]+45-3,0,22,90]
        print("pointtop1pre=",pointtop1pre)
        pointtop12=[(p1[0]/4)-2,p2[1]+8,p1[2]+45-3,0,22,90]
        print("pointtop12=",pointtop12)
        pointtop2=[(p4[0]/4),p2[1]+8,p1[2]+45-3,0,22,90]
        print("pointtop2=",pointtop2)
        pointtop2pre=[(p4[0]/4),p2[1]+2+8+10+5,p1[2]+45-3,0,22,90]
        print("pointtop2pre =",pointtop2pre)
        pointtop2air=[(p4[0]/4),p2[1]+5,p1[2]+45-3,0,22,90]
        print("pointtop2air =",pointtop2air)
        pointtop1Combo=[(p1[0]/4),p2[1]+5,p1[2]+45-3,0,22,90]
        ...
        #For Right Side
        pointright1=[(p4[0]/4)-8,p2[1],p1[2]+45-2,0,22,180]
        print("pointright1 =",pointright1)
        pointright1pre=[(p4[0]/4)-1-4,p2[1],p1[2]+45-2,0,22,180]
        print("pointright1pre =",pointright1pre)
        pointright12=[(p4[0]/4)-8,p2[1]-2,p1[2]+45-2,0,22,180]
        print("pointright12 =",pointright12)
        pointright2=[(p4[0]/4)-8,p4[0],p1[2]+45-2,0,22,180]
        print("pointright2 =",pointright2)
        pointright2pre=[(p4[0]/4)-1-4-5,p4[0],p1[2]+45-2,0,22,180]
    ...
    if xlen == "null":
        ...
        if xlen > 1000:
            return mod3tool2edgesbig(force,cps,section=section,return_home=return_home,pass_index=pass_index)
        else:
            return mod3tool2edgesmall(force,cps,section=section,return_home=return_home,pass_index=pass_index)
    else:
