...
def mod3tool2edgesbig(force,cps,section=None,return_home=True):
    def mod3tool2edgesbig(force,cps,section=None,return_home=True):
        ...
        point2air=[p1[0]/4,p1[1]-5,p1[2]+45-3,0,21.998,-90]
        ...
        pointtop2air=[(p4[0]/4),p2[1]+5,p1[2]+45-3,0,21.998,90]
        print("pointtop2air =",pointtop2air)
        pointtop1Combo=[(p1[0]/4),p2[1]+5,p1[2]+45-3,0,21.998,90]
    ...
    if xlen == "null":
        ...
        if xlen > 1000:
            mod3tool2edgesbig(force,cps,section=section,return_home=return_home)
        else:
            mod3tool2edgesmall(force,cps,section=section,return_home=return_home)
    else:
