...
from model5cycle.tool2sidebig import tool2sidebig
...
def mod5tool2sidesrun(force,cps,section=None,return_home=True,pass_index=None):
    def mod5tool2sidesmall(force,cps,section=None,return_home=True,pass_index=None):
    ...
    if xlen == "null":
        ...
        if xlen > 1000:
            return tool2sidebig(force,cps,section=section,return_home=return_home,pass_index=pass_index)
        else:
            return mod5tool2sidesmall(force,cps,section=section,return_home=return_home,pass_index=pass_index)
    else:
