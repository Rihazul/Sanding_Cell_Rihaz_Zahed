...
def mod1tool2sidesrun(force,cps):
    def mod1tool2sidesbig(force,cps):
        ...
        #Left Points
        pointleft1=[(p1[0]/12)+6,p4[1],p1[2]+45,0,0,0]
        print("pointleft1=",pointleft1)
        pointleft1pre=[(p1[0]/12)+2+5,p4[1],p1[2]+45,0,0,0]
        print("pointleft1pre=",pointleft1pre)
        pointleft12=[(p1[0]/12)+6,p4[1]+1+1,p1[2]+45,0,0,0]
        print("pointleft12=",pointleft12)
        pointleft2=[(p1[0]/12)+6,p2[1],p1[2]+45,0,0,0]
        print("pointleft2=",pointleft2)
        pointleft2pre=[(p1[0]/12)+2+5+10,p2[1],p1[2]+45,0,0,0]
        ...
        #Top Cycle Points
        pointtop1=[(p1[0]/12),p2[1]+6,p1[2]+45,0,0,90]
        print("pointtop1=",pointtop1)
        pointtop1pre=[(p1[0]/12),p2[1]+2+8,p1[2]+45,0,0,90]
        print("pointtop1pre=",pointtop1pre)
        pointtop12=[(p1[0]/12)-1-1,p2[1]+6,p1[2]+45,0,0,90]
        print("pointtop12=",pointtop12)
        pointtop2=[(p4[0]/12),p2[1]+6,p1[2]+45,0,0,90]
        print("pointtop2=",pointtop2)
        pointtop2pre=[(p4[0]/12),p2[1]+2+8+10,p1[2]+45,0,0,90]
        print("pointtop2pre =",pointtop2pre)
        pointtop2air=[(p4[0]/12),p2[1]+2+3+10,p1[2]+45,0,0,90]
        print("pointtop2air =",pointtop2air)
        pointtop1Combo=[(p1[0]/12),p2[1]+2+3+10,p1[2]+45,0,0,90]
        print("pointtop1Combo =",pointtop1Combo)

        #TopMain Minus Points
        pointtop3=[-(p1[0]/12),p2[1]+6,p1[2]+45,0,0,90]
        print("pointtop3=",pointtop3)
        pointtop3pre=[-(p1[0]/12),p2[1]+2+8+10,p1[2]+45,0,0,90]
        print("pointtop3pre =",pointtop3pre)
        pointtop3air=[-(p1[0]/12),p2[1]+2+3+10,p1[2]+45,0,0,90]
