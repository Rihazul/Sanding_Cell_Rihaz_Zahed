...
x_coords1 = [point13u[0], point14u[0], point15u[0], point16u[0]]
y_coords2 = [point13u[1], point14u[1], point15u[1], point16u[1]]
z_coords3 = [point13u[2], point14u[2], point15u[2], point16u[2]]
...
zigzag_path,prepoint = generate_zigzag_path(x_coords=x_coords1, y_coords=y_coords2, z_coords=z_coords3, innerOffset=5,innerOffsetX=5)
print("zigzag_path",zigzag_path)
print("Prepoint:", prepoint)

zigzag_path1,prepoint1 = generate_zigzag_path(x_coords=x_coords1, y_coords=y_coords2, z_coords=z_coords3, innerOffset=5,innerOffsetX=0)
print("zigzag_path1",zigzag_path1)
