...
def testmodel4tool2sidesmallfunction(force,cps):
    def testmodel4tool2sidesmallfunctionsmall(force,cps):
    ...
    if xlen == "null":
        ...
        if xlen > 1000:
            testmodel4tool2sidesmallfunctionbig(force,cps)
        else:
            testmodel4tool2sidesmallfunctionsmall(force,cps)
    else:
