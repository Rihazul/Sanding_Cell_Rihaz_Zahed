...
def testmodel4tool2sidesmallfunctionbig(force,cps,section=None,return_home=True,pass_index=None):
    ...
    point2=[p1[0]/5,p1[1]+0-4,p1[2]+45,0,0,-90]
    print("point2=",point2)
    ...
    #Left Points
    pointleft1=[(p1[0]/5)+6,p4[1],p1[2]+45,0,0,0]
    print("pointleft1=",pointleft1)
    pointleft1pre=[(p1[0]/5)+2+5,p4[1],p1[2]+45,0,0,0]
    print("pointleft1pre=",pointleft1pre)
    pointleft12=[(p1[0]/5)+6,p4[1]+1+1,p1[2]+45,0,0,0]
    print("pointleft12=",pointleft12)
    pointleft2=[(p1[0]/5)+6,p2[1],p1[2]+45,0,0,0]
    print("pointleft2=",pointleft2)
    pointleft2pre=[(p1[0]/5)+2+5+10,p2[1],p1[2]+45,0,0,0]
    ...
    pointtop3=[-(p1[0]/5),p2[1]+6,p1[2]+45,0,0,90]
    print("pointtop3=",pointtop3)
    pointtop3pre=[-(p1[0]/5),p2[1]+2+8+10,p1[2]+45,0,0,90]
    print("pointtop3pre =",pointtop3pre)
    pointtop3air=[-(p1[0]/5),p2[1]+2+3+10,p1[2]+45,0,0,90]
    ...
    for cx in cx_points:
        communicate(cps=cps, config=config, point=point2air, 
                tcp=config['coords']['tcpSideTool'], 
                ucs=config['coords']['ucsTable2'],
                seventh=-1, speed=speed_profile['travel'], velocity_profile="robot", wait=True)
...
if __name__ == "__main__":
   testmodel4tool2sidesmallfunctionbig()
