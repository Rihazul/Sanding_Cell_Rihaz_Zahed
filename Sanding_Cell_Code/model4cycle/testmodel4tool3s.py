...
from model4cycle.testmodel4tool3b import testmodel4tool3b
...
def testmodel4tool3s(force,cps):
    def testmodel4tool3small(force,cps):
        ...
        # print("seventhdistance:", seventhdistance)
        # tx2=outeroffset+outeroffset1+seventhdistance
        # print("tx2:", tx2)
        # tx3=outeroffset+outeroffset1+(seventhdistance*2)
        # print("tx3:", tx3)
        # tx4=outeroffset+outeroffset1+(seventhdistance*3)
        # print("tx4:", tx4)
        # tx5=outeroffset+outeroffset1+(seventhdistance*4)
        # print("x5:", tx5)
        # tx6=outeroffset+outeroffset1+(seventhdistance*5)
        # print("x6:", tx6)
    ...
    if xlen == "null":
        ...
        if xlen > 1000:
            testmodel4tool3b(force,cps)
        else:
            testmodel4tool3small(force,cps)
    else:
