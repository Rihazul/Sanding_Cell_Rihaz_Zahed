...
def testmodel4tooloutedgesmallfunction(force,cps,section=None,return_home=True,pass_index=None):
    ...
    def testmodel4tooloutedgesmallfunctionsmall(force,cps,section=None,return_home=True,pass_index=None):
    ...
    if xlen == "null":
        ...
        if xlen > 1000:
           return testmodel4tooloutedgesmallfunctionbig(force,cps,section=section,return_home=return_home,pass_index=pass_index)
        else:
            return testmodel4tooloutedgesmallfunctionsmall(force,cps,section=section,return_home=return_home,pass_index=pass_index)
    else:
