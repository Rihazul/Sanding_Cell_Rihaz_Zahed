...
def testmodel4tooloutedgesmallfunctionbig(force,cps,section=None,return_home=True,pass_index=None):
    ...
    point2=[p1[0]/5,p1[1]+0-8,p1[2]+45,0,22,-90]
    print("point2=",point2)
    point2pre=[p1[0]/5,p1[1]-5-10,p1[2]+45,0,22,-90]
    print("point2pre=",point2pre)
    point2air=[p1[0]/5,p1[1]-20,p1[2]+45,0,22,-90]
    ...
    #Left Points
    pointleft1=[(p1[0]/5)+10,p4[1],p1[2]+45,0,22,0]
    print("pointleft1=",pointleft1)
    pointleft1pre=[(p1[0]/5)+2+5,p4[1],p1[2]+45,0,22,0]
    print("pointleft1pre=",pointleft1pre)
    pointleft12=[(p1[0]/5)+10,p4[1]+1+1,p1[2]+45,0,22,0]
    print("pointleft12=",pointleft12)
    pointleft2=[(p1[0]/5)+10,p2[1],p1[2]+45,0,22,0]
    print("pointleft2=",pointleft2)
    pointleft2pre=[(p1[0]/5)+2+5+10,p2[1],p1[2]+45,0,22,0]
    ...
    #Top Cycle Points
    pointtop1=[(p1[0]/5),p2[1]+10,p1[2]+45,0,22,90]
    print("pointtop1=",pointtop1)
    pointtop1pre=[(p1[0]/5),p2[1]+2+8,p1[2]+45,0,22,90]
    print("pointtop1pre=",pointtop1pre)
    pointtop12=[(p1[0]/5)-1-1,p2[1]+10,p1[2]+45,0,22,90]
    print("pointtop12=",pointtop12)
    pointtop2=[(p4[0]/5),p2[1]+10,p1[2]+45,0,22,90]
    print("pointtop2=",pointtop2)
    pointtop2pre=[(p4[0]/5),p2[1]+2+8+10,p1[2]+45,0,22,90]
    print("pointtop2pre =",pointtop2pre)
    pointtop2air=[(p4[0]/5),p2[1]+2+3+10,p1[2]+45,0,22,90]
    print("pointtop2air =",pointtop2air)
    pointtop1Combo=[(p1[0]/5),p2[1]+2+3+10,p1[2]+45,0,22,90]
    print("pointtop1Combo =",pointtop1Combo)

    #TopMain Minus Points
    pointtop3=[-(p1[0]/5),p2[1]+10,p1[2]+45,0,22,90]
    print("pointtop3=",pointtop3)
    pointtop3pre=[-(p1[0]/5),p2[1]+2+8+10,p1[2]+45,0,22,90]
    print("pointtop3pre =",pointtop3pre)
    pointtop3air=[-(p1[0]/5),p2[1]+2+3+10,p1[2]+45,0,22,90]
    ...
    #RightCycle
    pointright1=[(p4[0]/5)-8,p2[1],p1[2]+45,0,22,180]
    print("pointright1 =",pointright1)
    pointright1pre=[(p4[0]/5)-1-4,p2[1],p1[2]+45,0,22,180]
    print("pointright1pre =",pointright1pre)
    pointright12=[(p4[0]/5)-8,p2[1]-1-1,p1[2]+45,0,22,180]
    print("pointright12 =",pointright12)
    pointright2=[(p4[0]/5)-8,p4[0],p1[2]+45,0,22,180]
    print("pointright2 =",pointright2)
    pointright2pre=[(p4[0]/5)-1-4-10,p4[0],p1[2]+45,0,22,180]
    ...
    if selected_section is not None:
        ...
        if pass_index is not None:
            ...
            if selected_section == "bottom":
                bottom_followup_passes = [cx1, cx2, cx3, cx4]
                if current_pass_index == 0:
                ...
                top_passes = [tcx5, tcx4, tcx3, tcx2, tcx1]
                ...
                perform_process_top(cps, config, points1=pointstopmain)
        ...
        if selected_section == "bottom":
            ...
            for cx_val in [tcx5, tcx4, tcx3, tcx2, tcx1]:
                run_single_movement(robot_point=pointtop1Combo, seventh_axis_point=cx_val, cps=cps, config=config)
                perform_process_top(cps, config, points1=pointstopmain)
                communicate(cps=cps, config=config, point=pointtop3air if 'pointtop3air' in locals() else pointtop2air, tcp=config['coords']['tcpSideTool'], ucs=config['coords']['ucsTable2'], seventh=-1, speed=speeed, velocity_profile="robot", wait=True)
            communicate(cps=cps,config=config,point=pointtopExtra,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=speeed,velocity_profile="robot", wait=True)
    ...
    communicate(cps=cps,config=config,seventh=cx,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],speed=speeed,velocity_profile="robot", wait=True)
    communicate(cps=cps,config=config,point=pointhome,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=speeed,velocity_profile="robot", wait=True)
    perform_process_bottom(cps, config, points1=pointsb)
    ...
    communicate(cps=cps,config=config,point=point2air,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=speed_profile['travel'],velocity_profile="robot", wait=True)
    communicate(
                cps=cps,
                config=config,
                seventh=tcx5,
...
if __name__ == "__main__":
    testmodel4tooloutedgesmallfunctionbig()
