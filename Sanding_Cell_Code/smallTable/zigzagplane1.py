...
def smalldoor1zizag(force,z):
    
    def smalldoor1zizagsmall(force,z):
        ...
        #Points calculation
        point5=[-p5[0],p5[1],z,p5[3],p5[4],0]
        print("point5:", point5)
        point6=[-p6[0],p6[1],z,p6[3],p6[4],0]
        print("point6:", point6)
        point7=[-p7[0],p7[1],z,p7[3],p7[4],0]
        print("point7:", point7)
        point8=[-p8[0],p8[1],z,p8[3],p8[4],0]
        print("point8:", point8)
        ...
        zigzag_pathp1,prepointp1= generate_zigzag_path(x_coords=x_coords1, y_coords=y_coords1, z_coords=z_coords1, innerOffset=5,innerOffsetX=5)
    ...
    def smalldoor1zizagbig(force,z):
        ...
        zigzag_pathp2,prepointp2= generate_zigzag_path(x_coords=x_coords1, y_coords=y_coords1, z_coords=z_coords1, innerOffset=5,innerOffsetX=5)
    ...
    if ylen == "null":
        ...
        if ylen > 600:
            smalldoor1zizagbig(force,z)
        else:
            smalldoor1zizagsmall(force,z)
    else:
        print(f"Invalid ylen value type: {type(ylen)} - expected number or 'null'")

def smalldoor2zizag(force):
...
def smalldoor4zizag(force):
    ...
    print("distance:", distance)
    #Points calculation
    point5=[-p5[0],p5[1],z,p5[3],p5[4],p5[5]]
    print("point5:", point5)
    point6=[-p6[0],p6[1],z,p6[3],p6[4],p6[5]]
    print("point6:", point6)
    point7=[-p7[0],p7[1],z,p7[3],p7[4],p7[5]]
    print("point7:", point7)
    point8=[-p8[0],p8[1],z,p8[3],p8[4],p8[5]]
    print("point8:", point8)
...
if __name__ == "__main__":
    ...
    smalldoor2zizag(force=5)
    smalldoor3zizag(force=5)
    #smalldoor4zizag(force=5)