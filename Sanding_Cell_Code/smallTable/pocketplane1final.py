...
def smalldoor1pocket(force,z,cps):
    def smalldoor1pocketsidebig(force,z,cps):
            ...
            communicate(cps=cps,config=config,point=midhoming,tcp=config['coords']['tcptool1plane1'],ucs=config['coords']['ucsTable1'],seventh=-1,speed=0.7,wait=True)
    ...
    def smalldoor1pocketsidesmall(force,z,cps):
        # Load configuration from YAML
        config = load_config()
    ...
    if ylen == "null":
        ...
        if ylen > 600:
            smalldoor1pocketsidebig(force,z,cps)
        else:
            smalldoor1pocketsidesmall(force,z,cps)
    else:
        print(f"Invalid ylen value type: {type(ylen)} - expected number or 'null'")


def smalldoor2pocket(force,z,cps):
    def smalldoor2pocketsidebig(force,z,cps):
            # Load configuration from YAML
            config = load_config()
            ...
            #Main Points
            b0 = get_pocket_point(2, 0)
            print("b0:", b0)
            b1 = get_pocket_point(2, 1)
            print("b1:", b1)
            b2= get_pocket_point(2, 2)
            print("b2:", b2)
            b3 = get_pocket_point(2, 3)
            print("b3", b3)
            #7th axis postion
            ...
            communicate(cps=cps,config=config,point=midhoming,tcp=config['coords']['tcptool1plane1'],ucs=config['coords']['ucsTable1'],seventh=-1,speed=0.7,wait=True)
            #communicate(cps=cps,config=config,seventh=conx1,tcp=config['coords']['tcptool1plane1'],ucs=config['coords']['ucsTable1'],speed=0.2,wait=True)
    def smalldoor2pocketsidesmall(force,z,cps):
        # Load configuration from YAML
        config = load_config()
    ...
    if ylen == "null":
        ...
        if ylen > 600:
            smalldoor2pocketsidebig(force,z,cps)
        else:
            smalldoor2pocketsidesmall(force,z,cps)
    else:
        print(f"Invalid ylen value type: {type(ylen)} - expected number or 'null'")

def smalldoor3pocket(force,z,cps):
    def smalldoor3pocketsidebig(force,z,cps):
            # Load configuration from YAML
            config = load_config()
            ...
            #Main Points
            b0 = get_pocket_point(3, 0)
            print("b0:", b0)
            b1 = get_pocket_point(3, 1)
            print("b1:", b1)
            b2= get_pocket_point(3, 2)
            print("b2:", b2)
            b3 = get_pocket_point(3, 3)
            print("b3", b3)
            #7th axis postion
            ...
            communicate(cps=cps,config=config,point=midhoming,tcp=config['coords']['tcptool1plane1'],ucs=config['coords']['ucsTable1'],seventh=-1,speed=0.7,wait=True)
            #communicate(cps=cps,config=config,seventh=conx1,tcp=config['coords']['tcptool1plane1'],ucs=config['coords']['ucsTable1'],speed=0.2,wait=True)
    def smalldoor3pocketsidesmall(force,z,cps):
        # Load configuration from YAML
        config = load_config()
        ...
        bottom0=[b0[0]+1.5*offset,b0[1]+offset,z,b0[3],b0[4],0]
        print("bottom0:", bottom0)
        bottom3=[b3[0]+3,b3[1]-2,z,b3[3],b3[4],0]
        print("bottom3:", bottom3)
        bottom0pre=[b0[0]+offset,b0[1]+offset,10,b0[3],b0[4],0]
        print("bottom0pre:", bottom0pre)
        bottom3pre=[b3[0]-offset,b3[1]+offset,10,b3[3],b3[4],0]
        print("bottom3pre:", bottom3pre)
        bottom03=[b0[0]+offset+2-2,b0[1]+offset,z,b0[3],b0[4],0]
        print("bottom03:", bottom03)
        bottom2= [b2[0]+3,b2[1]-2*offset+2,z,b2[3],b2[4],0]
        print("bottom2:", bottom2)
        bottom1= [b1[0]+1.5*offset,b1[1]-2*offset+2,z,b1[3],b1[4],0]
        print("bottom1:", bottom1)
        bottom1pre= [b1[0]+offset,b1[1]-offset,10,b1[3],b1[4],0]
        print("bottom1pre:", bottom1pre)
    ...
    if ylen == "null":
        ...
        if ylen > 600:
            smalldoor3pocketsidebig(force,z,cps)
        else:
            smalldoor3pocketsidesmall(force,z,cps)
    else:
        print(f"Invalid ylen value type: {type(ylen)} - expected number or 'null'")

def smalldoor4pocket(force,z,cps):
    def smalldoor4pocketsidebig(force,z,cps):
            # Load configuration from YAML
            config = load_config()
            ...
            #Main Points
            b0 = get_pocket_point(4, 0)
            print("b0:", b0)
            b1 = get_pocket_point(4, 1)
            print("b1:", b1)
            b2= get_pocket_point(4, 2)
            print("b2:", b2)
            b3 = get_pocket_point(4, 3)
            print("b3", b3)
            #7th axis postion
            ...
            communicate(cps=cps,config=config,point=midhoming,tcp=config['coords']['tcptool1plane1'],ucs=config['coords']['ucsTable1'],seventh=-1,speed=0.7,wait=True)
            #communicate(cps=cps,config=config,seventh=conx1,tcp=config['coords']['tcptool1plane1'],ucs=config['coords']['ucsTable1'],speed=0.2,wait=True)
    def smalldoor4pocketsidesmall(force,z,cps):
        # Load configuration from YAML
        config = load_config()
    ...
    if ylen == "null":
        ...
        if ylen > 600:
            smalldoor4pocketsidebig(force,z,cps)
        else:
            smalldoor4pocketsidesmall(force,z,cps)
    else:
        print(f"Invalid ylen value type: {type(ylen)} - expected number or 'null'")

if __name__ == "__main__":
    #smalldoor1pocket(force=2,z=-6.5)
    #smalldoor2pocket(force=2,z=-6.5)
    smalldoor3pocket(force=2,z=-6.5)
    #smalldoor4pocket(force=2,z=-6.5)
