...
def door1frametool2side(force):
    ...
    uprightpoint4=[-distance+40,p2[1]/2,10,180,-22,180]
    ...
    uprightpoint4up=[-distance+40,p2[1]/2+2,10,180,-22,180]
    print("uprightpoint4up:", uprightpoint4up)
    uprightpoint2=[-distance+40,p2[1],10,180,-22,180]
    ...
    #ExtraUpright
    extraupright=[-distance-10,p2[1]+10,10,180,0,90]
    ...
    uptoppoint1=[-distance,p2[1]-40,10,180,-22,90]
    print("uptoppoint1:", uptoppoint1)
    preuptoppoint1=[-distance,p2[1]-40+10,10,180,-22,90]
    print("preuptoppoint1:", preuptoppoint1)
    uptoppoint12=[-distance+2,p2[1]-40,10,180,-22,90]
    print("uptoppoint12:", uptoppoint12)
    uptoppoint2=[distance,p3[1]-40,10,180,-22,90]
    print("uptoppoint2:", uptoppoint2)
    preuptoppoint2=[distance,p3[1]+10-40,10,180,-22,90]
    ...
    #Up extra top points
    upextratop=[distance+10,p3[1]-20,10,180,0,0]
    print("upextratop:", upextratop)

    #Extratop
    extratop=[p3[0]+20,p3[1]+10,10,180,0,0]
    ...
    communicate(cps=cps,config=config,point=bottomextra,tcp=config['coords']['tcptool2plane1'],ucs=config['coords']['ucsTable1'],seventh=-1,speed=0.2,wait=True)
    perform_process_right(cps, config, points1=righthalfpointsdown,force=force)
    communicate(cps=cps,config=config,point=rightpositionhoming,tcp=config['coords']['tcptool2plane1'],ucs=config['coords']['ucsTable1'],seventh=-1,speed=0.2,wait=True)
    moveOnlyJ6r(cps, -270, config)

    #Top cycles
    communicate(cps=cps,config=config,seventh=x2,tcp=config['coords']['tcptool2plane1'],ucs=config['coords']['ucsTable1'],speed=0.2,wait=True)
    communicate(cps=cps,config=config,point=prehomeuprightpoint,tcp=config['coords']['tcptool2plane1'],ucs=config['coords']['ucsTable1'],seventh=-1,speed=0.2,wait=True)
    perform_process_upright(cps, config, points1=uprightpoints,force=force)
    communicate(cps=cps,config=config,point=extraupright,tcp=config['coords']['tcptool2plane1'],ucs=config['coords']['ucsTable1'],seventh=-1,speed=0.2,wait=True)
    perform_process_topup(cps, config, points1=uptoppoints,force=force)
    communicate(cps=cps,config=config,point=upextratop,tcp=config['coords']['tcptool2plane1'],ucs=config['coords']['ucsTable1'],seventh=-1,speed=0.2,wait=True)
    perform_process_upleft(cps, config, points1=upleftpoints,force=force)
    communicate(cps=cps,config=config,point=upleftextrahome,tcp=config['coords']['tcptool2plane1'],ucs=config['coords']['ucsTable1'],seventh=-1,speed=0.2,wait=True)
    moveOnlyJ6r(cps, -90, config)

def door2frametool2side(force):
    ...
    #Up extra top points
    upextratop=[distance+10,p3[1],10,180,0,0]
    print("upextratop:", upextratop)
...
if __name__ == "__main__":
    ...
    door1frametool2side(force=1)
    #door2frametool2side(force=1)
    #door3frametool2side(force=1)
