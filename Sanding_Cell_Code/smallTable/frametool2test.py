...
def door1frametool2side(force):
    ...
    uprightpoint4=[-distance*2-1,p2[1]/2,10,180,0,180]
    ...
    uprightpoint4up=[-distance*2-1,p2[1]/2+2,10,180,0,180]
    print("uprightpoint4up:", uprightpoint4up)
    uprightpoint2=[-distance*2-1,p2[1],10,180,0,180]
    ...
    #ExtraUpright
    extraupright=[(-distance*2)-10,p2[1]+10,10,180,0,90]
    ...
    #Up extra top points
    upextratop=[0+10,p3[1],10,180,0,0]
    ...
    leftpoint2=[p4[0]+2,p4[1],10,180,0,0]
    ...
    leftpoint5=[p3[0]+2,p3[1]/2,10,180,0,0]
    print("leftpoint5:", leftpoint5)
    leftpoint5down=[p3[0]+2,p3[1]/2-2,10,180,0,0]
