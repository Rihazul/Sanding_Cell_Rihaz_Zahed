...
def smalldoor1zizag(
    ...
    def smalldoor1zizagsmall(force,z,cps):
        ...
        zigzag_pathp1,prepointp1= generate_zigzag_path(x_coords=x_coords1, y_coords=y_coords1, z_coords=z_coords1,innerOffset=9,innerOffsetX=1)
...
def smalldoor2zizag(
    ...
    def smalldoor2zizagsmall(force,z,cps):
        ...
        #Second Pocket 1st Cycle
        zigzag_pathp1,prepointp1= generate_zigzag_path(x_coords=x_coords1, y_coords=y_coords1, z_coords=z_coords1,innerOffset=5,innerOffsetX=2)
        print("zigzag_pathp=",zigzag_pathp1)
        print("prepointp:", prepointp1)
