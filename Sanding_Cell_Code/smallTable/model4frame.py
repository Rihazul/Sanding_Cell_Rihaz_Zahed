...
def smalldoor1side(force,cps):
    def smalldoor1sidesmall(force,cps,speed,sanding_speed):
        ...
        b0 = [b00[0]+offsetframe, b00[1]+offsetframe, b00[2], b00[3], b00[4], 0]
        print("b0:", b0)
        b1 = [b10[0]+offsetframe, b10[1]-offsetframe, b10[2], b10[3], b10[4], 0]
        print("b1:", b1)
        b2 = [b20[0]-offsetframe, b20[1]-offsetframe, b20[2], b20[3], b20[4], 0]
        print("b2:", b2)
        b3 = [b30[0]-offsetframe, b30[1]+offsetframe, b30[2], b30[3], b30[4], 0]
        print("b3", b3)

        #Bottom Points
        bottom0=[b0[0],b0[1],3,b0[3],b0[4],0]
        print("bottom0:", bottom0)
        bottom3=[b3[0],b3[1],3,b3[3],b3[4],0]
        ...
        bottom03=[b0[0]+2,b0[1],3,b0[3],b0[4],0]
        print("bottom03:", bottom03)
        bottom2= [b2[0],b2[1],3,b2[3],b2[4],0]
        print("bottom2:", bottom2)
        bottom1= [b1[0],b1[1],3,b1[3],b1[4],0]
