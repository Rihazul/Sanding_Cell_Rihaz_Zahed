...
import yaml
import threading
from Server_Better_V2 import communicate,setup_logger,waitForBlending,turn_vibration_on,turn_vibration_off,putForce,releaseForce,putForceZplus,putForceZminus,msg_to_frontend,stop_requested
...
def homingtotal(cps=None, config=None):
    ...
    communicate(cps=cps,config=config,seventh=-65,tcp=config['coords']['tcptool1plane1'],ucs=config['coords']['ucsTable1'],speed=0.7,wait=True)
