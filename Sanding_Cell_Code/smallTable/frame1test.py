...
def smalldoorprocess(force):
    ...
    #Modified Points
    toppoint2=[(b2[0]-b1[0])/2,b2[1]-2*offset,z,b2[3],b2[4],0]
    print("toppoint2:", toppoint2)
    toppoint5=[(b2[0]-b1[0])/2,b2[1]/2,z,b2[3],b2[4],0]
    print("toppoint5:", toppoint5)
    toppoint5top=[(b2[0]-b1[0])/2,b2[1]/2+2,z,b2[3],b2[4],0]
    print("toppoint5top:", toppoint5top)
    toppoint5pre=[(b2[0]-b1[0])/2,b2[1]/2,10,b2[3],b2[4],0]
    print("toppoint5pre:", toppoint5pre)
    toppoint1=[-(b2[0]-b1[0])/2+1.5*offset,b2[1]-2*offset,z,b2[3],b2[4],0]
    print("toppoint1:", toppoint1)
    toppoint4=[-(b2[0]-b1[0])/2+1.5*offset,b2[1]/2,z,b2[3],b2[4],0]
    print("toppoint4:", toppoint4)
    toppoint4top=[-(b2[0]-b1[0])/2+1.5*offset,b2[1]/2+2,z,b2[3],b2[4],0]
    ...
    communicate(cps=cps,config=config,point=toppoint5pre,tcp=config['coords']['tcptool1plane1'],ucs=config['coords']['ucsTable1'],seventh=-1,speed=0.2,wait=True)
