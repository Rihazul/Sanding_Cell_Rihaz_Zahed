...
def testmodel2tool2edgerun(force,cps,section=None,return_home=True):
    def testmodel2tool2small(force,cps,section=None,return_home=True):
        ...
        #Top Cycle Points
        pointtop1=[(p1[0]/2),p2[1]+8,p1[2]+45,0,21.998,90]
        print("pointtop1=",pointtop1)
        pointtop1pre=[(p1[0]/2),p2[1]+2+8,p1[2]+45,0,21.998,90]
        print("pointtop1pre=",pointtop1pre)
        pointtop12=[(p1[0]/2)-1-1,p2[1]+8,p1[2]+45,0,21.998,90]
        print("pointtop12=",pointtop12)
        pointtop2=[(p4[0]/2),p2[1]+8,p1[2]+45,0,21.998,90]
        ...
        pointtop3=[-(p1[0]/2),p2[1]+8,p1[2]+45,0,21.998,90]
    ...
    if xlen == "null":
        ...
        if xlen > 600:
            tool2edgebig(force, cps, section=section, return_home=return_home)
        else:
            testmodel2tool2small(force, cps, section=section, return_home=return_home)
    else:
