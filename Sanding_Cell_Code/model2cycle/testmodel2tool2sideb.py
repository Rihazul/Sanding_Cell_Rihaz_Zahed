...
def testmodel2tool2sidesbigfunction(force,cps,section=None,return_home=True,pass_index=None):
    ...
    point2=[p1[0]/5,p1[1]+0-1.5,p1[2]+45,0,0,-90]
    print("point2=",point2)
    ...
    pointtop3=[-(p1[0]/12),p2[1]+4,p1[2]+45,0,0,90]
...
if __name__ == "__main__":
    testmodel2tool2sidesbigfunction(force=5)
