...
def tool2edgebig(force):
    ...
    point2=[p1[0]/5,p1[1]+0-8,p1[2]+45,0,21.998,-90]
    print("point2=",point2)
    point2pre=[p1[0]/5,p1[1]-5-10,p1[2]+45,0,21.998,-90]
    print("point2pre=",point2pre)
    point2air=[p1[0]/5,p1[1]-20,p1[2]+45,0,21.998,-90]
    ...
    #Top Cycle Points
    pointtop1=[(p1[0]/12),p2[1]+8,p1[2]+45,0,21.998,90]
    print("pointtop1=",pointtop1)
    pointtop1pre=[(p1[0]/12),p2[1]+2+8,p1[2]+45,0,21.998,90]
    print("pointtop1pre=",pointtop1pre)
    pointtop12=[(p1[0]/12)-1-1,p2[1]+8,p1[2]+45,0,21.998,90]
    print("pointtop12=",pointtop12)
    pointtop2=[(p4[0]/12),p2[1]+8,p1[2]+45,0,21.998,90]
    ...
    pointtop3=[-(p1[0]/12),p2[1]+8,p1[2]+45,0,21.998,90]
    ...
    #RightCycle
    pointright1=[(p4[0]/5)-8,p2[1],p1[2]+45,0,21.998,180]
    print("pointright1 =",pointright1)
    pointright1pre=[(p4[0]/5)-1-4,p2[1],p1[2]+45,0,21.998,180]
    print("pointright1pre =",pointright1pre)
    pointright12=[(p4[0]/5)-8,p2[1]-1-1,p1[2]+45,0,21.998,180]
    print("pointright12 =",pointright12)
    pointright2=[(p4[0]/5)-8,p4[0],p1[2]+45,0,21.998,180]
    print("pointright2 =",pointright2)
    pointright2pre=[(p4[0]/5)-1-4-10,p4[0],p1[2]+45,0,21.998,180]
