...
from model2cycle.testmodel2sidesbig import testmodel2sidebig
from model2cycle.testmodel2pocketoutsm import testmodelpocketoutsmall
...
def testmodel2siderun(force,cps):
    def testmodel2sidesmall(force,cps):
        ...
        pointybottomb2m=[length/2,pointybottomb,z,180,0,0]
        print("pointybottomb2m=",pointybottomb2m)
        prepointybottomb2m=[length/2,pointybottomb,-10,180,0,0]
        ...
        pointybottoma12m=[length/2+2,pointybottoma,z,180,0,0]
        print("pointybottoma12m=",pointybottoma12m)
        pointybottoma2m=[length/2,pointybottoma,z,180,0,0]
        print("pointybottoma2m=",pointybottoma2m)
        prepointybottoma2m=[length/2,pointybottoma,-10,180,0,0]
