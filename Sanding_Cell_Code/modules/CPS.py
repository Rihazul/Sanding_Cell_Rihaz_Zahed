...
class RbtClient(object):
    ...
    def sendAndRecv(self,cmd,result):
        try:
            ...
            #print("length of retData:",len(retData))
...
class CPSClient(object):
    ...
    *	@param return: 错误码
    '''
    def HRIF_MoveToSS(self,boxID,rbtID):
        result = []
        command = 'MoveToSS,'
        command += str(rbtID) + ','
        command += ';'
    ...
    *	@param return: 错误码
    '''
    def HRIF_HRSetMaxSearchDistance(self,boxID,rbtID,AllowDistance1,AllowDistance2,AllowDistance3,AllowDistance4,AllowDistance5,AllowDistance6):
        result = []    
    ...
    *	@param return: 错误码
    '''
    def HRIF_HRSetFTMovingAvgFilterParams(self,boxID,rbtID,ForceState,TorqueState,ForceLength,TorqueLength):
        result = []    
    ...
    *	@param return: 错误码
    '''
    def HRIF_MoveLinearWeave(self,boxID,rbtID,StartPoint,EndPoint,dVelocity,Acc,dRadius,dAmplitude,dIntervalDistance,nWeaveFrameType,\
                    dElevation,dAzimuth,dCentreRise,nEnableWaiTime,nPosiTime,nNegaTime,sTcpName,sUcsName,sCmdID):
        result = []
    ...
    *	@param return: 错误码
    '''
    def HRIF_MoveCircularWeave(self,boxID,rbtID,StartPoint,AuxPoint,EndPoint,dVelocity,Acc,dRadius,nOrientMode,nMoveWhole,dMoveWholeLen,dAmplitude,dIntervalDistance,nWeaveFrameType,\
                    dElevation,dAzimuth,dCentreRise,nEnableWaiTime,nPosiTime,nNegaTime,sTcpName,sUcsName,sCmdID):
        result = []
    ...
    def HRIF_MovePathJOL(self,boxID,rbtID,dVel,dAcc,dRadius,sPoints):
        result = []
        command = 'MovePathJOL,'
        command += str(rbtID) + ','
        command += str(dVel) + ','
