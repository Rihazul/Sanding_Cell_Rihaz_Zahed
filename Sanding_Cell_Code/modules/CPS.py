...
class CPSClient(object):
    ...
    *             nRet>0 : Error code of function call
    ...
    '''
        ...
        *	@param boxID: Control box ID
        *	@param rbtID: Robot ID
        *	@param dVel : Motion speed, mm/s
        *	@param dAcc : Motion acceleration, mm/(s^2)
        *	@param dJerkRatio : Motion jerk ratio, range from 1 to 100
        *	@param dTransitionParam : Blending transition param, °
        *	@param nPointCount : Point number
        *	@param pointData : Point data of two-dimensional array
        *	
        *	@return : nRet=0 : Function call succeeded
        *             nRet>0 : Error code of function call
        '''

    def HRIF_MoveJS(self, boxID, rbtID, dVel, dAcc, dJerkRatio, dTransitionParam, nPointCount, pointData):
        result = []
        command = 'MoveJS,'
        command += str(rbtID) + ','
        command += str(dVel) + ','
        ...
        command += str(dTransitionParam) + ','
        command += str(nPointCount) + ','
