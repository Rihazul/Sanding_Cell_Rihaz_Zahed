...
def main():
    ...
    #Bootom Points
    pointbottom1=[p4[0]+framewidth/2,p4[1]+framewidth/2,p4[2],p4[3],p4[4],p4[5]]
    print("pointbottom1=",pointbottom1)
    pointbottom2=[width/8-framewidth/2,p4[1]+framewidth/2,p4[2],p4[3],p4[4],p4[5]]
    ...
    pointbottom2pre=[width/8-framewidth/2,p4[1]+framewidth/2,p4[2]-15,p4[3],p4[4],p4[5]]
    print("pointbottom2pre=",pointbottom2pre)
    pointbottom12=[p4[0]+framewidth/2+2,p4[1]+framewidth/2,p4[2],p4[3],p4[4],p4[5]]
    ...
    conveyerbottoms=[x0,x1,x2,x3,x4,x5,x6,x7,x8]
    ...
    communicate(cps=cps,config=config,point=pointbottomair,tcp=config['coords']['tcpReal'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=0.7,wait=True)
    #Bottom Cycle 1
