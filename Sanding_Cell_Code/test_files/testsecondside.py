...
def main():
    ...
    #Bottom Side Cycle
    points1=[27.837,175.189,-1,180,0,0]
    points12=[28.837,175.189,-1,180,0,0] 
    points2=[482.220,175.189,-1,180,0,0]
    points3=[482.220,627.459,-1,180,0,0]
    points4=[27.837,627.459,-1,180,0,0]
    points1pre=[27.837,175.189,-4,180,0,0]
    pointshome=[27.837,175.189,-143.068,180,0,0]


    points1=[points1pre,points1,points12,points2,points3,points4,points1,points1pre]
    ...
    def perform_process_top(cps, config, points1):
        ...
        for point in points1:
            if point==points12:putForceZplus(
            cps=cps,
            force=30,
            tcp=config['coords']['tcpReal'],
            ucs=config['coords']['ucsTable2'],
    ...
    communicate(cps=cps,config=config,point=pointshome,tcp=config['coords']['tcpReal'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=0.2,wait=True)
    #turn_vibration_on(cps)
