...
def main():
    ...
    #Bottom Section
    point4=[p4[0]+tool3x-9.749,p4[1]+tool3y-19.243,p4[2]-1,p4[3],p4[4],p4[5]]
    print("point4=",point4)
    point1=[p1[0]/5,p4[1]+tool3y-19.243,p4[2]-1,p4[3],p4[4],p4[5]]
    print("point1=",point1)
    point41=[p4[0]+tool3x-9.749+2,p4[1]+tool3y-19.243,p4[2]-1,p4[3],p4[4],p4[5]]
    ...
    pointl23=[p4[0]-tool3x+11.138,p4[1]+tool3y-19.243+1+1,p4[2]-1,p4[3],p4[4],p4[5]]
    print("pointl23=",pointl23)

    #Top1
    pointtop2=[p2[0]/5-32.4,p2[1]-27.04,p2[2]-1,p2[3],p2[4],p2[5]]
    print("pointtop2=",pointtop2)
    pointtop21=[p2[0]/5-32.4-1-1,p2[1]-27.04,p2[2]-1,p2[3],p2[4],p2[5]]
    ...
    point14right=[0+tool3x-9.749,p2[1]-tool3y+23.76-1-1,p2[2]-1,p2[3],p2[4],p2[5]]
    ...
    point12middle=[p12[0]/2,0+tool3y-20.8+1+1,-1,180,0,0]
    ...
    communicate(cps=cps,config=config,point=point4air,tcp=config['coords']['tcpReal'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=0.7,wait=True)
    #turn_vibration_on(cps)
