...
def main():
    ...
    point1pre=[p4[0],p4[1]-5,p4[2]+45-3,0,41.998,-90]
    print("point1pre=",point1pre)
    point1=[p4[0],p4[1]+1,p4[2]+45-3,0,41.998,-90]
    print("point1=",point1)
    point12=[p4[0]+2,p4[1]+1,p4[2]+45-3,0,41.998,-90]
    print("point12=",point12)
    point2=[p1[0]/5,p1[1]+1,p1[2]+45-3,0,41.998,-90]
    print("point2=",point2)
    point2before=[(p1[0]/5)-1,p1[1]+1,p1[2]+45-3,0,41.998,-90]
    print("point2before=",point2before)
    point2pre=[p1[0]/5,p1[1]-5-5-10-5,p1[2]+45-3,0,41.998,-90]
    print("point2pre=",point2pre)
    point2air=[p1[0]/5,p1[1]-20,p1[2]+45-3,0,41.998,-90]
    print("point2air=",point2air)
    point1Combo=[0,p1[1]-20,p1[2]+45-3,0,41.998,-90]
    ...
    #Left Points
    pointleft1=[(p1[0]/5)+2,frameOutside/2,p1[2]+45-3,0,41.998,0]
    print("pointleft1=",pointleft1)
    pointleft1pre=[(p1[0]/5)+2+5,frameOutside/2,p1[2]+45-3,0,41.998,0]
    print("pointleft1pre=",pointleft1pre)
    pointleft12=[(p1[0]/5)+2,(frameOutside/2)+2,p1[2]+45-3,0,41.998,0]
    print("pointleft12=",pointleft12)
    pointleft2=[(p1[0]/5)+2,p2[1]-(frameOutside/2),p1[2]+45-3,0,41.998,0]
    print("pointleft2=",pointleft2)
    pointleft2pre=[(p1[0]/5)+2+5+10,p2[1]-(frameOutside/2),p1[2]+45-3,0,41.998,0]
    ...
    #Top Cycle Points
    pointtop1=[(p1[0]/5),p2[1]+2+2,p1[2]+45-3,0,41.998,90]
    print("pointtop1=",pointtop1)
    pointtop1pre=[(p1[0]/5),p2[1]+2+8,p1[2]+45-3,0,41.998,90]
    print("pointtop1pre=",pointtop1pre)
    pointtop12=[(p1[0]/5)-2,p2[1]+2+2,p1[2]+45-3,0,41.998,90]
    print("pointtop12=",pointtop12)
    pointtop2=[(p4[0]/5),p2[1]+2+2,p1[2]+45-3,0,41.998,90]
    print("pointtop2=",pointtop2)
    pointtop2pre=[(p4[0]/5),p2[1]+2+8+10+5,p1[2]+45-3,0,41.998,90]
    print("pointtop2pre =",pointtop2pre)
    pointtop2air=[(p4[0]/5),p2[1]+2+3+10,p1[2]+45-3,0,41.998,90]
    print("pointtop2air =",pointtop2air)
    pointtop1Combo=[(p1[0]/5),p2[1]+2+3+10,p1[2]+45-3,0,41.998,90]
    ...
    #For Right Side
    pointright1=[(p4[0]/5)-1,p2[1],p1[2]+45-2,0,41.998,180]
    print("pointright1 =",pointright1)
    pointright1pre=[(p4[0]/5)-1-4,p2[1],p1[2]+45-2,0,41.998,180]
    print("pointright1pre =",pointright1pre)
    pointright12=[(p4[0]/5)-1,p2[1]-2,p1[2]+45-2,0,41.998,180]
    print("pointright12 =",pointright12)
    pointright2=[(p4[0]/5)-1,p4[0],p1[2]+45-2,0,41.998,180]
    print("pointright2 =",pointright2)
    pointright2pre=[(p4[0]/5)-1-4-5,p4[0],p1[2]+45-2,0,41.998,180]
    ...
    #Bottom Cycle 2
    communicate(cps=cps,config=config,point=point2air,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=0.7,wait=True)
    run_single_movement(robot_point=point1Combo, seventh_axis_point=cx1, cps=cps, config=config)
    perform_process_bottom(cps, config, points1=pointsb)
    #Bottom Cycle 3
    communicate(cps=cps,config=config,point=point2air,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=0.7,wait=True)
    run_single_movement(robot_point=point1Combo, seventh_axis_point=cx2, cps=cps, config=config)
    perform_process_bottom(cps, config, points1=pointsb)
    #Bottom Cycle 4
    communicate(cps=cps,config=config,point=point2air,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=0.7,wait=True)
    ...
    communicate(cps=cps,config=config,point=point2bottomextra,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=0.7,wait=True)

    #Left Cycle
    perform_process_left(cps, config, points1=pointsleft)
    #Left Cycle Extrea
    communicate(cps=cps,config=config,point=pointLeftExtra,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=0.7,wait=True)
    #Top Cycle 1
    perform_process_top(cps, config, points1=pointstop)
    #Top Cycle 2
    communicate(cps=cps,config=config,point=pointtop2air,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=0.7,wait=True)
    ...
    #Top Cycle Extra
    communicate(cps=cps,config=config,point=pointtop2air,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=0.7,wait=True)
    communicate(cps=cps,config=config,point=pointtopExtra,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=0.7,wait=True)

    #Right Cycle
    perform_process_right(cps, config, points1=pointsright)
    communicate(cps=cps,config=config,seventh=-19,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],speed=0.7,wait=True)
    communicate(cps=cps,config=config,point=homelast,tcp=config['coords']['tcpSideTool'],ucs=config['coords']['ucsTable2'],seventh=-1,speed=0.7,wait=True)
