...
def main():
    ...
    print("point1=",point1)
    point12=[p4[0]+1+1,p4[1]+0,p4[2]+45,0,0,-90]
    print("point12=",point12)
    point2=[p1[0]/5,p1[1]+0,p1[2]+45,0,0,-90]
    print("point2=",point2)
    point2pre=[p1[0]/5,p1[1]-5-10,p1[2]+45,0,0,-90]
    ...
    pointleft12=[(p1[0]/5)+3,(frameOutside/2)+1+1,p1[2]+45,0,0,0]
    print("pointleft12=",pointleft12)
    pointleft2=[(p1[0]/5)+3,p2[1]-(frameOutside/2),p1[2]+45,0,0,0]
    print("pointleft2=",pointleft2)
    pointleft2pre=[(p1[0]/5)+2+5+10,p2[1]-(frameOutside/2),p1[2]+45,0,0,0]
