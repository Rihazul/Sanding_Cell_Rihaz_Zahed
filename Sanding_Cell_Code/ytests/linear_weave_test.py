...
def build_cases(config: dict, tcp: str | None, ucs: str | None) -> list[dict[str, Any]]:
    ...
    start = _pad_point(points_cfg.get("safePoint") or [-572.28, -12.00, 582.59, 0, 0, 179.99])
...
def main(argv: list[str]) -> int:
    ...
    parser.add_argument("--tcp", default="TCP_tool3plane1", help="Override TCP name (defaults to coords.tcpDefault or 'TCP').")
    ...
    parser.add_argument("--wait-timeout", type=float, default=7.0, help="Seconds to wait for idle/blending.")
